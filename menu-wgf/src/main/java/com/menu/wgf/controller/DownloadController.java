...
//            fos = new FileOutputStream(new File("G://uploadFiles//" + uploadFileName
//                    + ".")
//                    + uploadFileSuffix);
...
//        }
//    }
    @RequestMapping(value = "/testUploadFile", method = RequestMethod.POST,consumes = "multipart/form-data")
    public void testUploadFile(HttpServletRequest req,
            ...
            if (!file.isEmpty()) {
                try {
                    ...
                    stream = new BufferedOutputStream(new FileOutputStream(new File(
                            "G://uploadFiles//" + uploadFileName + "." + uploadFileSuffix)));

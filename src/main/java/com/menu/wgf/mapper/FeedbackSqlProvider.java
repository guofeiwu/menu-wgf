...
import com.menu.wgf.model.FeedbackCriteria.Criteria;
import com.menu.wgf.model.FeedbackCriteria.Criterion;
...
public class FeedbackSqlProvider {
    ...
    public String countByExample(FeedbackCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_feedback");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(FeedbackCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_feedback");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    protected void applyWhere(SQL sql, FeedbackCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
